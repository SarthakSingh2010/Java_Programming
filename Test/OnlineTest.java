...
class OnlineTest extends JFrame implements ActionListener
{
	...
	void set()
	{
		...
		if(current==4)
		{
			l.setText("Que5: Which of the is not a OOPS concept?");
			jb[0].setText("Encapsulation");jb[1].setText("Inheritance");jb[2].setText("Finalization");jb[3].setText("Polymorphism");
		}
		if(current==5)
		{
